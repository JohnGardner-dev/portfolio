    ...
    return (
        <div className='group relative flex cursor-pointer'>
            <motion.img
                ...
                // className='object-cover h-20 w-20 md:h-28 md:w-28 xl:h-32 xl:w-32 filter group-hover:grayscale transition duration-300 ease-in-out'
                className='object-cover h-20 w-20 md:h-28 md:w-28 xl:h-32 xl:w-32 filter'
            />
